...
if __name__ == '__main__':
    ...
    # file_name = csv_file_name.split('/')[2]
    ...
    use_stemmer = False
    # csv_file_name = sys.argv[1]
    csv_file_name = './dataset/test.csv'
    file_name = csv_file_name.split('/')[2]
    processed_file_name = file_name[:-4] + '-processed.csv'
    if use_stemmer:
        porter_stemmer = PorterStemmer()
        processed_file_name = file_name[:-4] + '-processed-stemmed.csv'
